...
public class NodeTest {
    ...
    public void readTest(){
        ...
        LeafPageElement element1 = new LeafPageElement(0,leafPageElementSize*3,3,4); // pos = sizeof(leafPageElement)*3
        LeafPageElement element2 = new LeafPageElement(0,leafPageElementSize*2+3+4,10,3); // pos = sizeof(leafPageElement)*2 + 3 + 4
